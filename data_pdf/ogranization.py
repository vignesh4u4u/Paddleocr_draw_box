...
def text_from_pdf():
    if request.method == 'POST':
        ...
        if "names" in selected_options:
            ...
            words_to_remove = ["Tenant", "Walk", "Please","Premises","Emergency Service", "Lease","Front","Make","Emergency","LANDLORD","Rent Income","Rent","Landlord","Fire","Gas","Lot","Lot Rent","Follows","Monthly","Resident","Fist","Items","Unit","Family Alliance",
                               ...
                               "Eric Lewis ___","Eric Lewis Lessee","Dirty Floors","X Lessor Date","See","Crime Free","PARTIES AND","Repaint","LEASE","Rental","Pool","Keys",
                               ]
